...
// Strong defender, moves in straight lines
export const CorporalPig = ({ size = 40, className = "" }) => (
  ...
  >
    ...
    {/* Military helmet */}
    <ellipse cx="50" cy="18" rx="22" ry="12" fill="#4B5563" stroke="#374151" strokeWidth="2"/>
    <rect x="45" y="12" width="10" height="4" fill="#374151"/>
    {/* Snout */}
